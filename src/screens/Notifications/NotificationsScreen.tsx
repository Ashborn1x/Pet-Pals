...
const styles = StyleSheet.create({
  ...
  content: { alignSelf: 'center', flexGrow: 1, maxWidth: 560, padding: 22, paddingBottom: 110, width: '100%' },
  ...
  subtitle: { color: '#718276', fontSize: 12, marginTop: 4 },
  markReadButton: { alignItems: 'center', flexDirection: 'row', gap: 3, marginBottom: 4 },
  markReadText: { color: '#557A63', fontSize: 11, fontWeight: '700' },
  markReadDisabled: { color: '#A8B3AB' },
  list: { gap: 8, marginTop: 18 },
  card: { alignItems: 'center', backgroundColor: '#FAF8F3', borderColor: '#C5CEC5', borderRadius: 16, borderWidth: 1, elevation: 2, flexDirection: 'row', minHeight: 72, paddingHorizontal: 14, paddingVertical: 12, shadowColor: '#526558', shadowOpacity: 0.08, shadowRadius: 6 },
  readCard: { borderColor: '#E8E2D7', opacity: 0.72 },
  iconCircle: { alignItems: 'center', borderRadius: 19, height: 38, justifyContent: 'center', marginRight: 12, width: 38 },
  alertIcon: { backgroundColor: '#FCE5DF' },
  waterIcon: { backgroundColor: '#E5F0EC' },
  streakIcon: { backgroundColor: '#F5EBDD' },
  copy: { flex: 1 },
  titleRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
  cardTitle: { color: '#33483A', flex: 1, fontSize: 13, fontWeight: '800' },
  time: { color: '#9AA69D', fontSize: 10, marginLeft: 6 },
  detail: { color: '#718276', fontSize: 11, lineHeight: 16, marginTop: 4 },
